...
exports.bookinstance_delete_get = function(req, res, next) {
    ...
    .exec((err, bookinstance) => {
        ...
        res.render('bookinstance/bookinstance_delete', { title: 'Delete BookInstance', bookinstance: bookinstance});
    })
};
        ...
        if (!errors.isEmpty()) {
            ...
            Book.find({}, 'title')
                .exec(function (err, books) {
                    if (err) { return next(err); }
                    // Successful, so render.
                    res.render('bookinstance/bookinstance_form', { title: 'Update BookInstance', book_list: books, 
                    selected_book: bookinstance.book._id, errors: errors.array(), bookinstance: bookinstance });
                });
            return;
        }
